...
inline constexpr uint32_t kManifestMagic = 0x4E414D4Du; // "MMAN" (little-endian on the wire)
inline constexpr uint16_t kManifestFormat = 1;

inline constexpr uint16_t kManifestFlagDelta = 0x0001; // payload is a detools delta
